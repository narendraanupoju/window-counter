...
Original file is located at
    https://colab.research.google.com/drive/1HspsjCjMNGM0oVj4SJ_mhS3OatZmjzGC
"""
...
inpath= "data_colab/"
#model_path = r"C:\Users\dines\Desktop\vgg16_weights_tf_dim_ordering_tf_kernels.h5" 
...
inpath1="data_colab/window_dataset_02.08.19_01.txt"
inpath2="data_colab/"
	...
	with open(input_path,'r') as f:
		...
		for line in f:
			...
			if filename not in all_imgs:
				all_imgs[filename] = {}			
				img = cv2.imread(os.path.join(inpath2,filename))
				(rows,cols) = img.shape[:2]
				all_imgs[filename]['filepath'] = os.path.join(inpath2,filename)
...
#all_data, classes_count, class_mapping=get_data(inpath1)
#print(classes_count,class_name,class_mapping,filename,all_imgs)
...
print("shared_layer", shared_layers.shape)
